...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n pll_24m -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type pll -fin 24.000 -clkibuf LVCMOS33 -fclkop 96.000 -fclkop_tol 0.0 -fclkos 24.000 -fclkos_tol 0.0 -phases 0 -phase_cntl STATIC -fb_mode 1 -fdc C:/Users/kunsh/Desktop/AiCamera/Lattice Diamond/pll_24m/pll_24m.fdc  */
/* Wed Oct 29 19:00:15 2025 */


`timescale 1 ns / 1 ps
module pll_24m (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
