...
GLOBAL_PRIMARY_0_LOADNUM = 286;
; Global primary clock #1
GLOBAL_PRIMARY_1_SIGNALNAME = u_ctrl/u_ack/SD_CLK_c_enable_86;
GLOBAL_PRIMARY_1_DRIVERTYPE = SLICE;
GLOBAL_PRIMARY_1_LOADNUM = 0;
; Global primary clock #2
GLOBAL_PRIMARY_2_SIGNALNAME = u_cam_cfg/SD_CLK_c_enable_243;
...
GLOBAL_PRIMARY_4_SIGNALNAME = u_ctrl/u_cmd/SD_CLK_c_enable_163;
...
GLOBAL_PRIMARY_6_SIGNALNAME = u_sd/n36895;
GLOBAL_PRIMARY_6_DRIVERTYPE = SLICE;
GLOBAL_PRIMARY_6_LOADNUM = 0;
; Global primary clock #7
GLOBAL_PRIMARY_7_SIGNALNAME = u_sd/SD_CLK_c_enable_263;
