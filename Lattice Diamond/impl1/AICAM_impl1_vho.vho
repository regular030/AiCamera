...
-- Netlist written on Mon Nov 17 21:38:44 2025
...
-- entity fpga_top
  ...
  begin
    SLICE_0I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>pix_y_6, C1=>'X', D1=>'1', DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>pix_y_5, C0=>'X', D0=>'1', FCI=>n4527, 
                M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', FCO=>n4528, F1=>open, 
                Q1=>open, F0=>open, Q0=>open);
    SLICE_1I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   INIT0_INITVAL=>X"3333", INIT1_INITVAL=>X"3333")
      port map (M1=>'X', A1=>'X', B1=>pix_y_4, C1=>'X', D1=>'1', DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>pix_y_3, C0=>'X', D0=>'1', FCI=>n4526, 
                M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', FCO=>n4527, F1=>open, 
                Q1=>open, F0=>open, Q0=>open);
    SLICE_2I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   INIT0_INITVAL=>X"5555", INIT1_INITVAL=>X"3333")
      port map (M1=>'X', A1=>'X', B1=>pix_y_2, C1=>'X', D1=>'1', DI1=>'X', 
    ...
    SLICE_3I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>pix_x_8, C1=>'X', D1=>'1', DI1=>'X', 
    ...
    SLICE_5I: SCCU2C
      ...
      port map (M1=>'X', A1=>pix_y_4, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>n49_adj_1350, DI0=>n52, A0=>'X', B0=>pix_y_3, C0=>'X', 
    ...
    SLICE_7I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>pix_y_0, C1=>'X', D1=>'1', DI1=>'X', 
    ...
    SLICE_8I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>rptr_gray_11_N_1192_11, A0=>'X', B0=>n29, C0=>'X', 
    ...
    SLICE_9I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>n32, C1=>'X', D1=>'1', 
                DI1=>rptr_bin_11_N_1180_10, DI0=>rptr_bin_11_N_1180_9, A0=>'X', 
                B0=>n35, C0=>'X', D0=>'1', FCI=>n4523, M0=>'X', 
    ...
    SLICE_11I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>pix_y_2, C1=>'X', D1=>'1', DI1=>n55, 
                DI0=>n58, A0=>'X', B0=>pix_y_1, C0=>'X', D0=>'1', FCI=>n4497, 
    ...
    SLICE_12I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>n38, C1=>'X', D1=>'1', 
                DI1=>rptr_bin_11_N_1180_8, DI0=>rptr_bin_11_N_1180_7, A0=>'X', 
                B0=>n41, C0=>'X', D0=>'1', FCI=>n4522, M0=>'X', 
    ...
    SLICE_15I: SCCU2C
      ...
      port map (M1=>'X', A1=>n44, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>rptr_bin_11_N_1180_6, DI0=>rptr_bin_11_N_1180_5, A0=>'X', 
                B0=>n47, C0=>'X', D0=>'1', FCI=>n4521, M0=>'X', 
    ...
    SLICE_16I: SCCU2C
      ...
      port map (M1=>'X', A1=>n50, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>rptr_bin_11_N_1180_4, DI0=>rptr_bin_11_N_1180_3, A0=>'X', 
                B0=>n53, C0=>'X', D0=>'1', FCI=>n4520, M0=>'X', 
    ...
    SLICE_17I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>n56, C1=>'X', D1=>'1', 
                DI1=>rptr_bin_11_N_1180_2, DI0=>rptr_bin_11_N_1180_1, A0=>'X', 
                B0=>n59, C0=>'X', D0=>'1', FCI=>n4519, M0=>'X', 
    ...
    SLICE_18I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", CHECK_DI1=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>n62, C1=>'X', D1=>'1', 
    ...
    SLICE_19I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>wptr_gray_11_N_1157_11, A0=>'X', B0=>wptr_gray_11, 
    ...
    SLICE_20I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>wptr_bin_10, C1=>'X', D1=>'1', 
                DI1=>wptr_bin_11_N_1138_10, DI0=>wptr_bin_11_N_1138_9, A0=>'X', 
                B0=>wptr_bin_9, C0=>'X', D0=>'1', FCI=>n4517, M0=>'X', 
                CE=>u_stream_u_dc_wptr_bin_11_N_1150, CLK=>PCLK_c, LSR=>'X', 
    ...
    SLICE_21I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>wptr_bin_8_adj_1360, C1=>'X', D1=>'1', 
                DI1=>wptr_bin_11_N_1138_8, DI0=>wptr_bin_11_N_1138_7, A0=>'X', 
                B0=>wptr_bin_7_adj_1361, C0=>'X', D0=>'1', FCI=>n4516, M0=>'X', 
                CE=>u_stream_u_dc_wptr_bin_11_N_1150, CLK=>PCLK_c, LSR=>'X', 
                FCO=>n4517, F1=>wptr_bin_11_N_1138_8, Q1=>wptr_bin_8_adj_1360, 
                F0=>wptr_bin_11_N_1138_7, Q0=>wptr_bin_7_adj_1361);
    SLICE_22I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   INIT0_INITVAL=>X"CC00", INIT1_INITVAL=>X"AA00", 
      ...
      port map (M1=>'X', A1=>wptr_bin_6_adj_1362, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>wptr_bin_11_N_1138_6, DI0=>wptr_bin_11_N_1138_5, A0=>'X', 
                B0=>wptr_bin_5_adj_1363, C0=>'X', D0=>'1', FCI=>n4515, M0=>'X', 
                CE=>u_stream_u_dc_wptr_bin_11_N_1150, CLK=>PCLK_c, LSR=>'X', 
                FCO=>n4516, F1=>wptr_bin_11_N_1138_6, Q1=>wptr_bin_6_adj_1362, 
                F0=>wptr_bin_11_N_1138_5, Q0=>wptr_bin_5_adj_1363);
    SLICE_23I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   INIT0_INITVAL=>X"CC00", INIT1_INITVAL=>X"AA00", 
      ...
      port map (M1=>'X', A1=>wptr_bin_4_adj_1364, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>wptr_bin_11_N_1138_4, DI0=>wptr_bin_11_N_1138_3, A0=>'X', 
                B0=>wptr_bin_3_adj_1365, C0=>'X', D0=>'1', FCI=>n4514, M0=>'X', 
                CE=>u_stream_u_dc_wptr_bin_11_N_1150, CLK=>PCLK_c, LSR=>'X', 
                FCO=>n4515, F1=>wptr_bin_11_N_1138_4, Q1=>wptr_bin_4_adj_1364, 
                F0=>wptr_bin_11_N_1138_3, Q0=>wptr_bin_3_adj_1365);
    SLICE_24I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   INIT0_INITVAL=>X"CC00", INIT1_INITVAL=>X"CC00", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>wptr_bin_2_adj_1366, C1=>'X', D1=>'1', 
                DI1=>wptr_bin_11_N_1138_2, DI0=>wptr_bin_11_N_1138_1, A0=>'X', 
                B0=>wptr_bin_1_adj_1367, C0=>'X', D0=>'1', FCI=>n4513, M0=>'X', 
                CE=>u_stream_u_dc_wptr_bin_11_N_1150, CLK=>PCLK_c, LSR=>'X', 
                FCO=>n4514, F1=>wptr_bin_11_N_1138_2, Q1=>wptr_bin_2_adj_1366, 
                F0=>wptr_bin_11_N_1138_1, Q0=>wptr_bin_1_adj_1367);
    SLICE_25I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   INIT0_INITVAL=>X"0000", INIT1_INITVAL=>X"33FF", 
                   REG1_SD=>"VHI", CHECK_DI1=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>wptr_bin_0_adj_1368, C1=>'X', D1=>'1', 
    ...
    SLICE_26I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>timer_15, C0=>'X', D0=>'1', FCI=>n4496, 
                M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', FCO=>open, F1=>open, 
    ...
    SLICE_27I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>n36_adj_1378, A0=>'X', B0=>ref_cnt_15, C0=>'X', D0=>'1', 
    ...
    SLICE_31I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>n28_adj_1369, C1=>'X', D1=>'1', 
                DI1=>rptr_bin_9_N_922_8, DI0=>rptr_bin_9_N_922_7, A0=>'X', 
                B0=>n31_adj_1370, C0=>'X', D0=>'1', FCI=>n4511, M0=>'X', 
                CE=>SD_CLK_c_enable_63, CLK=>SD_CLK_c, LSR=>'X', FCO=>n4512, 
                F1=>rptr_bin_9_N_922_8, Q1=>n28_adj_1369, 
    ...
    SLICE_33I: SCCU2C
      ...
      port map (M1=>'X', A1=>ref_cnt_12, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>n45_adj_1381, DI0=>n48_adj_1382, A0=>'X', B0=>ref_cnt_11, 
    ...
    SLICE_34I: SCCU2C
      ...
      port map (M1=>'X', A1=>n34_adj_1371, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>rptr_bin_9_N_922_6, DI0=>rptr_bin_9_N_922_5, A0=>'X', 
                B0=>n37_adj_1372, C0=>'X', D0=>'1', FCI=>n4510, M0=>'X', 
                CE=>SD_CLK_c_enable_63, CLK=>SD_CLK_c, LSR=>'X', FCO=>n4511, 
                F1=>rptr_bin_9_N_922_6, Q1=>n34_adj_1371, 
    ...
    SLICE_35I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>ref_cnt_10, C1=>'X', D1=>'1', 
                DI1=>n51_adj_1383, DI0=>n54_adj_1384, A0=>'X', B0=>ref_cnt_9, 
    ...
    SLICE_36I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>ref_cnt_8, C1=>'X', D1=>'1', 
                DI1=>n57_adj_1385, DI0=>n60_adj_1386, A0=>'X', B0=>ref_cnt_7, 
    ...
    SLICE_37I: SCCU2C
      ...
      port map (M1=>'X', A1=>ref_cnt_6, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>ref_cnt_15_N_561_6, DI0=>ref_cnt_15_N_561_5, A0=>'X', 
                B0=>ref_cnt_5, C0=>'X', D0=>'1', FCI=>n4539, M0=>'X', 
    ...
    SLICE_38I: SCCU2C
      ...
      port map (M1=>'X', A1=>ref_cnt_4, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>n69_adj_1387, DI0=>n72_adj_1388, A0=>'X', B0=>ref_cnt_3, 
    ...
    SLICE_39I: SCCU2C
      ...
      port map (M1=>'X', A1=>n40_adj_1373, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>rptr_bin_9_N_922_4, DI0=>rptr_bin_9_N_922_3, A0=>'X', 
                B0=>n43_adj_1374, C0=>'X', D0=>'1', FCI=>n4509, M0=>'X', 
                CE=>SD_CLK_c_enable_63, CLK=>SD_CLK_c, LSR=>'X', FCO=>n4510, 
                F1=>rptr_bin_9_N_922_4, Q1=>n40_adj_1373, 
    ...
    SLICE_40I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>n46_adj_1375, C1=>'X', D1=>'1', 
                DI1=>rptr_bin_9_N_922_2, DI0=>rptr_bin_9_N_922_1, A0=>'X', 
                B0=>n49_adj_1376, C0=>'X', D0=>'1', FCI=>n4508, M0=>'X', 
                CE=>SD_CLK_c_enable_63, CLK=>SD_CLK_c, LSR=>'X', FCO=>n4509, 
                F1=>rptr_bin_9_N_922_2, Q1=>n46_adj_1375, 
    ...
    SLICE_41I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   INIT0_INITVAL=>X"0000", INIT1_INITVAL=>X"33FF", 
                   REG1_SD=>"VHI", CHECK_DI1=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>n52_adj_1377, C1=>'X', D1=>'1', 
    ...
    SLICE_45I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", CHECK_DI1=>TRUE, CHECK_CE=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>ref_cnt_0, C1=>'X', D1=>'1', DI1=>n81, 
    ...
    SLICE_46I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>wptr_gray_9_N_893_9, A0=>'X', B0=>wptr_gray_9, C0=>'X', 
    ...
    SLICE_47I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>wptr_bin_8, C1=>'X', D1=>'1', 
                DI1=>wptr_bin_9_N_876_8, DI0=>wptr_bin_9_N_876_7, A0=>'X', 
                B0=>wptr_bin_7, C0=>'X', D0=>'1', FCI=>n4506, M0=>'X', 
    ...
    SLICE_49I: SCCU2C
      ...
      port map (M1=>'X', A1=>wptr_bin_6, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>wptr_bin_9_N_876_6, DI0=>wptr_bin_9_N_876_5, A0=>'X', 
                B0=>wptr_bin_5, C0=>'X', D0=>'1', FCI=>n4505, M0=>'X', 
                CE=>wptr_bin_9_N_886, CLK=>PCLK_c, LSR=>'X', FCO=>n4506, 
                F1=>wptr_bin_9_N_876_6, Q1=>wptr_bin_6, F0=>wptr_bin_9_N_876_5, 
                Q0=>wptr_bin_5);
    SLICE_50I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   INIT0_INITVAL=>X"3333", INIT1_INITVAL=>X"0000")
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>pix_x_11, C0=>'X', D0=>'1', FCI=>n4536, 
    ...
    SLICE_51I: SCCU2C
      ...
      port map (M1=>'X', A1=>timer_4, B1=>'X', C1=>'X', D1=>'1', DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>timer_3, C0=>'X', D0=>'1', FCI=>n4490, 
    ...
    SLICE_54I: SCCU2C
      ...
      port map (M1=>'X', A1=>wptr_bin_4, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>wptr_bin_9_N_876_4, DI0=>wptr_bin_9_N_876_3, A0=>'X', 
                B0=>wptr_bin_3, C0=>'X', D0=>'1', FCI=>n4504, M0=>'X', 
    ...
    SLICE_55I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>pix_x_10, C1=>'X', D1=>'1', DI1=>'X', 
                DI0=>'X', A0=>'X', B0=>pix_x_9, C0=>'X', D0=>'1', FCI=>n4535, 
    ...
    SLICE_59I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>wptr_bin_2, C1=>'X', D1=>'1', 
                DI1=>wptr_bin_9_N_876_2, DI0=>wptr_bin_9_N_876_1, A0=>'X', 
                B0=>wptr_bin_1, C0=>'X', D0=>'1', FCI=>n4503, M0=>'X', 
    ...
    SLICE_60I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", CCU2_INJECT1_0=>"NO", 
                   ...
                   INIT0_INITVAL=>X"0000", INIT1_INITVAL=>X"33FF", 
                   REG1_SD=>"VHI", CHECK_DI1=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>wptr_bin_0, C1=>'X', D1=>'1', 
    ...
    SLICE_62I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>n28, A0=>'X', B0=>pix_y_11, C0=>'X', D0=>'1', FCI=>n4502, 
                M0=>'X', CE=>u_cam_PCLK_c_enable_50, CLK=>PCLK_c, LSR=>VSYNC_c, 
    ...
    SLICE_63I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>pix_y_10, C1=>'X', D1=>'1', DI1=>n31, 
                DI0=>n34, A0=>'X', B0=>pix_y_9, C0=>'X', D0=>'1', FCI=>n4501, 
                M0=>'X', CE=>u_cam_PCLK_c_enable_50, CLK=>PCLK_c, LSR=>VSYNC_c, 
    ...
    SLICE_65I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>pix_y_8, C1=>'X', D1=>'1', DI1=>n37, 
                DI0=>n40_adj_1351, A0=>'X', B0=>pix_y_7, C0=>'X', D0=>'1', 
    ...
    SLICE_66I: SCCU2C
      ...
      port map (M1=>'X', A1=>pix_y_6, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>n43_adj_1348, DI0=>n46_adj_1349, A0=>'X', B0=>pix_y_5, 
    ...
    u_stream_u_dc_SLICE_74I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", INIT0_INITVAL=>X"0099", 
                   INIT1_INITVAL=>X"9009")
      port map (M1=>'X', A1=>u_stream_u_dc_n1777, B1=>u_stream_u_dc_n1778, 
                C1=>u_stream_u_dc_n1776, D1=>u_stream_u_dc_n1775, DI1=>'X', 
                DI0=>'X', A0=>u_stream_u_dc_n1779, B0=>u_stream_u_dc_n1780, 
    ...
    u_stream_u_dc_SLICE_75I: SCCU2C
      ...
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>'X', A0=>u_stream_u_dc_wptr_gray_rd2_1, 
                B0=>u_stream_u_dc_rptr_gray_1, C0=>u_stream_u_dc_rptr_gray_0, 
    ...
    u_stream_u_dc_SLICE_76I: SCCU2C
      ...
      port map (M1=>'X', A1=>u_stream_u_dc_rptr_gray_3, 
                ...
                A0=>u_stream_u_dc_rptr_gray_4, 
                B0=>u_stream_u_dc_wptr_gray_rd2_5, 
                C0=>u_stream_u_dc_rptr_gray_5, 
    ...
    SLICE_82I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   INIT0_INITVAL=>X"5555", INIT1_INITVAL=>X"3333")
      port map (M1=>'X', A1=>'X', B1=>pix_y_10, C1=>'X', D1=>'1', DI1=>'X', 
    ...
    SLICE_83I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   INIT0_INITVAL=>X"5555", INIT1_INITVAL=>X"3333")
      port map (M1=>'X', A1=>'X', B1=>pix_y_8, C1=>'X', D1=>'1', DI1=>'X', 
    ...
    u_sdram_SLICE_84I: SCCU2C
      ...
      port map (M1=>'X', A1=>u_sdram_row_12, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>u_sdram_n58, DI0=>u_sdram_n59, A0=>'X', 
                B0=>u_sdram_row_11, C0=>'X', D0=>'1', FCI=>u_sdram_n4555, 
    ...
    u_sdram_SLICE_85I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>u_sdram_row_10, C1=>'X', D1=>'1', 
                DI1=>u_sdram_n60_adj_1317, DI0=>u_sdram_n61, A0=>'X', 
                B0=>u_sdram_row_9, C0=>'X', D0=>'1', FCI=>u_sdram_n4554, 
                M0=>'X', CE=>u_sdram_SD_CLK_c_enable_24, CLK=>SD_CLK_c, 
    ...
    u_sdram_SLICE_86I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>u_sdram_row_8, C1=>'X', D1=>'1', 
                DI1=>u_sdram_n62, DI0=>u_sdram_n63_adj_1308, A0=>'X', 
                B0=>u_sdram_row_7, C0=>'X', D0=>'1', FCI=>u_sdram_n4553, 
                M0=>'X', CE=>u_sdram_SD_CLK_c_enable_24, CLK=>SD_CLK_c, 
    ...
    u_sdram_SLICE_88I: SCCU2C
      ...
      port map (M1=>'X', A1=>u_sdram_row_4, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>u_sdram_n66_adj_1310, DI0=>u_sdram_n67, A0=>'X', 
                B0=>u_sdram_row_3, C0=>'X', D0=>'1', FCI=>u_sdram_n4551, 
                M0=>'X', CE=>u_sdram_SD_CLK_c_enable_24, CLK=>SD_CLK_c, 
    ...
    u_sdram_SLICE_90I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", CHECK_DI1=>TRUE, CHECK_CE=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>u_sdram_row_0, C1=>'X', D1=>'1', 
    ...
    u_sdram_SLICE_92I: SCCU2C
      ...
      port map (M1=>'X', A1=>u_sdram_col_6, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>u_sdram_n44, DI0=>u_sdram_n45_adj_1332, A0=>'X', 
                B0=>u_sdram_col_5, C0=>'X', D0=>'1', FCI=>u_sdram_n4547, 
    ...
    u_sdram_SLICE_93I: SCCU2C
      ...
      port map (M1=>'X', A1=>u_sdram_col_4, B1=>'X', C1=>'X', D1=>'1', 
                DI1=>u_sdram_n46, DI0=>u_sdram_n47, A0=>'X', B0=>u_sdram_col_3, 
    ...
    u_sdram_SLICE_95I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", CHECK_DI1=>TRUE, CHECK_CE=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'X', B1=>u_sdram_col_0, C1=>'X', D1=>'1', 
    ...
    u_sdram_u_fifo_SLICE_96I: SCCU2C
      generic map (CCU2_INJECT1_1=>"NO", INIT0_INITVAL=>X"9009", 
                   INIT1_INITVAL=>X"0000")
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>'X', A0=>u_sdram_u_fifo_wptr_gray_1, 
                B0=>u_sdram_u_fifo_rptr_gray_wr2_1, 
    ...
    u_sdram_u_fifo_SLICE_97I: SCCU2C
      generic map (CCU2_INJECT1_1=>"NO", INIT0_INITVAL=>X"9009", 
                   INIT1_INITVAL=>X"0000")
      port map (M1=>'X', A1=>'X', B1=>'X', C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>'X', A0=>u_sdram_u_fifo_n1823, B0=>u_sdram_u_fifo_n1824, 
    ...
    u_sdram_u_fifo_SLICE_104I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", INIT0_INITVAL=>X"00FF", 
                   INIT1_INITVAL=>X"9009")
      port map (M1=>'X', A1=>u_sdram_u_fifo_wptr_gray_7, 
                B1=>u_sdram_u_fifo_rptr_gray_wr2_7, 
    ...
    u_sdram_SLICE_164I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", GSR=>"DISABLED", 
                   ...
                   LUT1_INITVAL=>X"FF80", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>u_sdram_n6111, 
                B1=>u_sdram_ref_due_N_811, C1=>u_sdram_rd_empty, 
                D1=>u_sdram_n15, DI1=>u_sdram_timer_15_N_529_13, 
                DI0=>u_sdram_timer_15_N_529_12, A0=>n45, 
                B0=>u_sdram_SD_DQM_1_N_802_1, C0=>u_sdram_n6737, 
                D0=>u_sdram_n5090, M0=>'X', CE=>'X', CLK=>SD_CLK_c, LSR=>'X', 
                OFX1=>open, F1=>u_sdram_timer_15_N_529_13, Q1=>timer_13, 
                OFX0=>open, F0=>u_sdram_timer_15_N_529_12, Q0=>timer_12);
    ...
    u_sdram_u_fifo_SLICE_209I: SLOGICB
      ...
      port map (M1=>rptr_gray_9_N_932_9, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>u_sdram_u_fifo_rptr_gray_9_N_932_8, A0=>'X', 
                B0=>rptr_bin_9_N_922_8, C0=>'X', D0=>rptr_gray_9_N_932_9, 
                M0=>'X', CE=>SD_CLK_c_enable_63, CLK=>SD_CLK_c, LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>u_sdram_u_fifo_rptr_gray_9, 
    ...
    u_sdram_u_fifo_SLICE_221I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   ...
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>wptr_bin_9_N_876_4, B1=>'X', 
                C1=>wptr_bin_9_N_876_3, D1=>'X', 
                DI1=>u_sdram_u_fifo_wptr_gray_9_N_893_3, 
                DI0=>u_sdram_u_fifo_wptr_gray_9_N_893_2, A0=>'X', 
                B0=>wptr_bin_9_N_876_2, C0=>wptr_bin_9_N_876_3, D0=>'X', 
                M0=>'X', CE=>wptr_bin_9_N_886, CLK=>PCLK_c, LSR=>'X', 
    ...
    u_sdram_u_fifo_SLICE_222I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   ...
                   LUT1_INITVAL=>X"5A5A", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>wptr_bin_9_N_876_6, B1=>'X', 
                C1=>wptr_bin_9_N_876_5, D1=>'X', 
                DI1=>u_sdram_u_fifo_wptr_gray_9_N_893_5, 
                DI0=>u_sdram_u_fifo_wptr_gray_9_N_893_4, 
                A0=>wptr_bin_9_N_876_4, B0=>'X', C0=>wptr_bin_9_N_876_5, 
    ...
    u_sdram_u_fifo_SLICE_224I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                ...
                A0=>'X', B0=>wptr_bin_9_N_876_8, C0=>'X', 
                D0=>wptr_gray_9_N_893_9, M0=>'X', CE=>wptr_bin_9_N_886, 
                CLK=>PCLK_c, LSR=>'X', OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>u_sdram_u_fifo_wptr_gray_9_N_893_8, 
    ...
    u_stream_u_dc_SLICE_293I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   ...
                   LUT1_INITVAL=>X"33CC", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>rptr_bin_11_N_1180_2, 
                C1=>'X', D1=>rptr_bin_11_N_1180_1, 
                DI1=>u_stream_u_dc_rptr_gray_11_N_1192_1, 
                DI0=>u_stream_u_dc_rptr_gray_11_N_1192_0, A0=>'X', 
                B0=>rptr_bin_11_N_1180_0, C0=>'X', D0=>rptr_bin_11_N_1180_1, 
    ...
    u_stream_u_dc_SLICE_295I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   ...
                   LUT1_INITVAL=>X"33CC", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>rptr_bin_11_N_1180_6, 
                C1=>'X', D1=>rptr_bin_11_N_1180_5, 
                DI1=>u_stream_u_dc_rptr_gray_11_N_1192_5, 
                DI0=>u_stream_u_dc_rptr_gray_11_N_1192_4, A0=>'X', 
                B0=>rptr_bin_11_N_1180_4, C0=>'X', D0=>rptr_bin_11_N_1180_5, 
                M0=>'X', CE=>rd_data_7_N_1177, CLK=>CCLK_c, LSR=>'X', 
    ...
    u_stream_u_dc_SLICE_296I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   ...
                   LUT1_INITVAL=>X"33CC", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>rptr_bin_11_N_1180_8, 
                C1=>'X', D1=>rptr_bin_11_N_1180_7, 
                DI1=>u_stream_u_dc_rptr_gray_11_N_1192_7, 
                DI0=>u_stream_u_dc_rptr_gray_11_N_1192_6, 
                A0=>rptr_bin_11_N_1180_6, B0=>'X', C0=>'X', 
                D0=>rptr_bin_11_N_1180_7, M0=>'X', CE=>rd_data_7_N_1177, 
                CLK=>CCLK_c, LSR=>'X', OFX1=>open, 
                F1=>u_stream_u_dc_rptr_gray_11_N_1192_7, 
    ...
    u_stream_u_dc_SLICE_297I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", GSR=>"DISABLED", 
                   ...
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', 
                B1=>rptr_bin_11_N_1180_10, C1=>'X', D1=>rptr_bin_11_N_1180_9, 
                DI1=>u_stream_u_dc_rptr_gray_11_N_1192_9, 
                DI0=>u_stream_u_dc_rptr_gray_11_N_1192_8, A0=>'X', 
                B0=>rptr_bin_11_N_1180_8, C0=>'X', D0=>rptr_bin_11_N_1180_9, 
                M0=>'X', CE=>rd_data_7_N_1177, CLK=>CCLK_c, LSR=>'X', 
    ...
    u_stream_u_dc_SLICE_315I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', 
                ...
                M0=>'X', CE=>u_stream_u_dc_wptr_bin_11_N_1150, CLK=>PCLK_c, 
                LSR=>'X', OFX1=>open, F1=>u_stream_u_dc_wptr_gray_11_N_1157_9, 
    ...
    u_stream_i4624_SLICE_338I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>u_stream_n34, B1=>frame_start, 
                C1=>'X', D1=>u_stream_state_2, DI1=>'X', DI0=>'X', 
                A0=>u_stream_n34, B0=>u_stream_arm_pclk, C0=>u_stream_state_1, 
                D0=>u_stream_state_2, M0=>u_stream_state_0, CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>open, Q1=>open, 
    ...
    u_sdram_SLICE_354I: SLOGICB
      generic map (LUT0_INITVAL=>X"F1F0", LUT1_INITVAL=>X"FFFE")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>timer_3, B1=>timer_9, 
                C1=>timer_5, D1=>timer_6, DI1=>'X', DI0=>'X', A0=>u_sdram_n28, 
                B0=>u_sdram_n6348, C0=>u_sdram_n6734, D0=>u_sdram_n5823, 
                M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
    ...
    u_sdram_SLICE_396I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>u_sdram_row_10, 
                C1=>u_sdram_row_11, D1=>'X', DI1=>'X', DI0=>'X', 
                A0=>u_sdram_row_6, B0=>u_sdram_row_8, C0=>u_sdram_row_1, 
                D0=>u_sdram_row_7, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
    ...
    u_cam_SLICE_407I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>VSYNC_c, C0=>'X', 
                D0=>HREF_c, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
    ...
    u_spi_SLICE_438I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                ...
                B0=>stream_fifo_rd_data_7, C0=>'X', D0=>u_spi_cmd_1, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>open, Q1=>open, 
