...
// Netlist written on Thu Oct 30 00:30:09 2025
//
...
module fpga_top (CRYSTAL, PCLK, VSYNC, HREF, Y9, Y8, Y7, Y6, 
            ...
            PROGRAMN, INITN, DONE, SD_CLK, SD_CS_N, SD_WE_N, SD_RAS_N, 
            SD_CAS_N, SD_A, SD_BA, SD_DQ, SD_DQM) /* synthesis syn_module_defined=1 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(5[8:16])
    ...
    input PROGRAMN;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(23[25:33])
    input INITN;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(24[25:30])
    input DONE;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(25[25:29])
    output SD_CLK;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(28[25:31])
    output SD_CS_N;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(29[25:32])
    output SD_WE_N;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(30[25:32])
    output SD_RAS_N;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(31[25:33])
    output SD_CAS_N;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(32[25:33])
    output [12:0]SD_A;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    output [1:0]SD_BA;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(34[25:30])
    output [15:0]SD_DQ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(35[25:30])
    output [1:0]SD_DQM;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(36[25:31])
    ...
    wire SD_CLK_c /* synthesis SET_AS_NETWORK=SD_CLK_c, is_clock=1 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(28[25:31])
    ...
    wire [15:0]pix_rgb565;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(61[17:27])
    
    wire frame_start;
    wire [11:0]pix_x;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(65[17:22])
    wire [11:0]pix_y;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(65[24:29])
    
    wire n4537, stream_arm_spi;
    wire [7:0]stream_fifo_rd_data;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(185[17:36])
    ...
    pixel_assemble_rgb565 u_cam (.HREF_c(HREF_c), .byte_sel(byte_sel), .n67({n28_adj_1359, 
            ...
            .Y5_c_3(Y5_c_3), .Y4_c_2(Y4_c_2), .Y3_c_1(Y3_c_1), .pix_rgb565({pix_rgb565})) /* synthesis syn_module_defined=1 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(67[27] 80[6])
    IB Inst1_IB (.I(CRYSTAL), .O(buf_CLKI)) /* synthesis IO_TYPE="LVCMOS33", syn_instantiated=1, LSE_LINE_FILE_ID=4, LSE_LCOL=13, LSE_RCOL=6, LSE_LLINE=47, LSE_RLINE=51 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pll_24m/pll_24m.v(21[8:41])
    ...
    OB SD_WE_N_pad (.I(SD_WE_N_c), .O(SD_WE_N));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(30[25:32])
    OB SD_CS_N_pad (.I(VCC_net), .O(SD_CS_N));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(29[25:32])
    OB SD_CLK_pad (.I(SD_CLK_c), .O(SD_CLK));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(28[25:31])
    ...
    OB SD_RAS_N_pad (.I(SD_RAS_N_c), .O(SD_RAS_N));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(31[25:33])
    ...
    OB SD_CAS_N_pad (.I(SD_CAS_N_c), .O(SD_CAS_N));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(32[25:33])
    OB SD_A_pad_12 (.I(SD_A_c_12), .O(SD_A[12]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_11 (.I(SD_A_c_11), .O(SD_A[11]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_10 (.I(SD_A_c_10), .O(SD_A[10]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_9 (.I(SD_A_c_9), .O(SD_A[9]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_8 (.I(SD_A_c_8), .O(SD_A[8]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_7 (.I(SD_A_c_7), .O(SD_A[7]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_6 (.I(SD_A_c_6), .O(SD_A[6]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_5 (.I(SD_A_c_5), .O(SD_A[5]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_4 (.I(SD_A_c_4), .O(SD_A[4]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_3 (.I(SD_A_c_3), .O(SD_A[3]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_2 (.I(SD_A_c_2), .O(SD_A[2]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_1 (.I(SD_A_c_1), .O(SD_A[1]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_A_pad_0 (.I(SD_A_c_0), .O(SD_A[0]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(33[25:29])
    OB SD_BA_pad_1 (.I(SD_BA_c_1), .O(SD_BA[1]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(34[25:30])
    OB SD_BA_pad_0 (.I(SD_BA_c_0), .O(SD_BA[0]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(34[25:30])
    ...
    OB SD_DQM_pad_1 (.I(SD_DQM_c_0), .O(SD_DQM[1]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(36[25:31])
    OB SD_DQM_pad_0 (.I(SD_DQM_c_0), .O(SD_DQM[0]));   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(36[25:31])
    ...
    roi_streamer_rgb565 u_stream (.\pix_rgb565[4] (pix_rgb565[4]), .PCLK_c(PCLK_c), 
            ...
            .\rptr_bin_11__N_1180[0] (rptr_bin_11__N_1180[0]), .stream_fifo_empty(stream_fifo_empty)) /* synthesis syn_module_defined=1 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(188[25] 211[6])
    ...
    pll_24m u_pll (.SD_CLK_c(SD_CLK_c), .MCLK_c(MCLK_c), .buf_CLKI(buf_CLKI), 
            .GND_net(GND_net)) /* synthesis NGD_DRC_MASK=1, syn_module_defined=1 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(47[13] 51[6])
    sdram_ctrl_min u_sdram (.timer({timer}), .SD_CLK_c(SD_CLK_c), .SD_BA_c_0(SD_BA_c_0), 
            ...
            .\rptr_bin_9__N_922[0] (rptr_bin_9__N_922[0])) /* synthesis syn_module_defined=1 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(121[7] 141[6])
    spi_bridge u_spi (.CCLK_c(CCLK_c), .DIN_c(DIN_c), .stream_arm_spi(stream_arm_spi), 
            ...
            .rd_data_7__N_1177(rd_data_7__N_1177), .SSPI_CS_n_c(SSPI_CS_n_c)) /* synthesis syn_module_defined=1 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(216[16] 235[6])
    VLO i1 (.Z(GND_net));
...
module pixel_assemble_rgb565 (HREF_c, byte_sel, n67, PCLK_c, Y2_c_0, 
    ...
    FD1P3AX byte0_i0_i0 (.D(Y2_c_0), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1S3AX frame_start_37 (.D(VSYNC_c), .CK(PCLK_c), .Q(frame_start)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1S3IX byte_sel_42 (.D(byte_sel_N_202), .CK(PCLK_c), .CD(VSYNC_c), 
            .Q(byte_sel)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte_sel_42.GSR = "DISABLED";
    FD1S3IX pix_valid_36 (.D(n6754), .CK(PCLK_c), .CD(n2), .Q(pix_valid_rgb)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_valid_36.GSR = "DISABLED";
    FD1P3IX pix_x__i0 (.D(n892), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i0.GSR = "DISABLED";
    FD1P3IX pix_y__i0 (.D(n67_adj_24[0]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1P3AX byte0_i0_i7 (.D(Y9_c_7), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte0_i0_i7.GSR = "DISABLED";
    FD1P3AX byte0_i0_i6 (.D(Y8_c_6), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte0_i0_i6.GSR = "DISABLED";
    FD1P3AX byte0_i0_i5 (.D(Y7_c_5), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte0_i0_i5.GSR = "DISABLED";
    FD1P3AX byte0_i0_i4 (.D(Y6_c_4), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte0_i0_i4.GSR = "DISABLED";
    FD1P3AX byte0_i0_i3 (.D(Y5_c_3), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte0_i0_i3.GSR = "DISABLED";
    FD1P3AX byte0_i0_i2 (.D(Y4_c_2), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte0_i0_i2.GSR = "DISABLED";
    FD1P3AX byte0_i0_i1 (.D(Y3_c_1), .SP(PCLK_c_enable_12), .CK(PCLK_c), 
            .Q(byte0[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam byte0_i0_i1.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i15 (.D(byte0[7]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[15])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i15.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i14 (.D(byte0[6]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[14])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i14.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i13 (.D(byte0[5]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[13])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i13.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i12 (.D(byte0[4]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[12])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i12.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i11 (.D(byte0[3]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[11])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i11.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i10 (.D(byte0[2]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[10])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i10.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i9 (.D(byte0[1]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[9])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i9.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i8 (.D(byte0[0]), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[8])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i8.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i7 (.D(Y9_c_7), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i7.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i6 (.D(Y8_c_6), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i6.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i5 (.D(Y7_c_5), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i5.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i4 (.D(Y6_c_4), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i4.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i3 (.D(Y5_c_3), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i3.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i2 (.D(Y4_c_2), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_rgb565_i0_i2.GSR = "DISABLED";
    FD1P3AX pix_rgb565_i0_i1 (.D(Y3_c_1), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1P3IX pix_x__i1 (.D(n893), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1P3IX pix_x__i2 (.D(n894), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i2.GSR = "DISABLED";
    FD1P3IX pix_x__i3 (.D(n895), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i3.GSR = "DISABLED";
    FD1P3IX pix_x__i4 (.D(n896), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i4.GSR = "DISABLED";
    FD1P3IX pix_x__i5 (.D(n897), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i5.GSR = "DISABLED";
    FD1P3IX pix_x__i6 (.D(n898), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i6.GSR = "DISABLED";
    FD1P3IX pix_x__i7 (.D(n899), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i7.GSR = "DISABLED";
    FD1P3IX pix_x__i8 (.D(n900), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[8])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i8.GSR = "DISABLED";
    FD1P3IX pix_x__i9 (.D(n901), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[9])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i9.GSR = "DISABLED";
    FD1P3IX pix_x__i10 (.D(n902), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[10])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_x__i10.GSR = "DISABLED";
    FD1P3IX pix_x__i11 (.D(n903), .SP(PCLK_c_enable_39), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_x[11])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1P3IX pix_y__i1 (.D(n67_adj_24[1]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1P3IX pix_y__i2 (.D(n67_adj_24[2]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i2.GSR = "DISABLED";
    FD1P3IX pix_y__i3 (.D(n67_adj_24[3]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i3.GSR = "DISABLED";
    FD1P3IX pix_y__i4 (.D(n67_adj_24[4]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i4.GSR = "DISABLED";
    FD1P3IX pix_y__i5 (.D(n67_adj_24[5]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i5.GSR = "DISABLED";
    FD1P3IX pix_y__i6 (.D(n67_adj_24[6]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i6.GSR = "DISABLED";
    FD1P3IX pix_y__i7 (.D(n67_adj_24[7]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i7.GSR = "DISABLED";
    FD1P3IX pix_y__i8 (.D(n67_adj_24[8]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[8])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i8.GSR = "DISABLED";
    FD1P3IX pix_y__i9 (.D(n67_adj_24[9]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[9])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i9.GSR = "DISABLED";
    FD1P3IX pix_y__i10 (.D(n67_adj_24[10]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[10])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    defparam pix_y__i10.GSR = "DISABLED";
    FD1P3IX pix_y__i11 (.D(n67_adj_24[11]), .SP(PCLK_c_enable_50), .CD(VSYNC_c), 
            .CK(PCLK_c), .Q(pix_y[11])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
    ...
    FD1P3AX pix_rgb565_i0_i0 (.D(Y2_c_0), .SP(PCLK_c_enable_51), .CK(PCLK_c), 
            .Q(pix_rgb565[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=27, LSE_RCOL=6, LSE_LLINE=67, LSE_RLINE=80 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/pixel_assemble_rgb565.v(19[12] 52[8])
...
module roi_streamer_rgb565 (\pix_rgb565[4] , PCLK_c, stream_arm_spi, frame_start, 
    ...
    FD1S3AX arm_pclk_56 (.D(arm_meta), .CK(PCLK_c), .Q(arm_pclk)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(25[12] 28[8])
    defparam arm_pclk_56.GSR = "DISABLED";
    FD1S3AX arm_meta_55 (.D(stream_arm_spi), .CK(PCLK_c), .Q(arm_meta)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(25[12] 28[8])
    ...
    FD1P3AX state_i2 (.D(state_2__N_943[2]), .SP(PCLK_c_enable_4), .CK(PCLK_c), 
            .Q(state[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam state_i2.GSR = "DISABLED";
    FD1S3IX wr_data_i0 (.D(\pix_rgb565[0] ), .CK(PCLK_c), .CD(n3142), 
            .Q(wr_data[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam wr_data_i0.GSR = "DISABLED";
    FD1P3AX state_i1 (.D(state_2__N_943[1]), .SP(PCLK_c_enable_5), .CK(PCLK_c), 
            .Q(state[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam state_i1.GSR = "DISABLED";
    FD1S3IX wr_en_57 (.D(n6728), .CK(PCLK_c), .CD(n2796), .Q(wr_en)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam wr_en_57.GSR = "DISABLED";
    FD1S3IX wr_data_i1 (.D(n6291), .CK(PCLK_c), .CD(n3168), .Q(wr_data[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    ...
    PFUMX state_2__I_0_61_Mux_4_i7 (.BLUT(n4933), .ALUT(n6), .C0(state[2]), 
          .Z(wr_data_7__N_946[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;
    FD1P3AX state_i0 (.D(state_2__N_943[0]), .SP(PCLK_c_enable_28), .CK(PCLK_c), 
            .Q(state[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam state_i0.GSR = "DISABLED";
    FD1S3IX wr_data_i2 (.D(\pix_rgb565[2] ), .CK(PCLK_c), .CD(n3142), 
            .Q(wr_data[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam wr_data_i2.GSR = "DISABLED";
    FD1S3IX wr_data_i3 (.D(n6293), .CK(PCLK_c), .CD(n3168), .Q(wr_data[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam wr_data_i3.GSR = "DISABLED";
    FD1S3AX wr_data_i4 (.D(wr_data_7__N_946[4]), .CK(PCLK_c), .Q(wr_data[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam wr_data_i4.GSR = "DISABLED";
    FD1S3IX wr_data_i5 (.D(n6295), .CK(PCLK_c), .CD(n3168), .Q(wr_data[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam wr_data_i5.GSR = "DISABLED";
    FD1S3IX wr_data_i6 (.D(\pix_rgb565[6] ), .CK(PCLK_c), .CD(n3142), 
            .Q(wr_data[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
    defparam wr_data_i6.GSR = "DISABLED";
    FD1S3IX wr_data_i7 (.D(n6297), .CK(PCLK_c), .CD(n3168), .Q(wr_data[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=25, LSE_RCOL=6, LSE_LLINE=188, LSE_RLINE=211 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/roi_streamer_rgb565.v(58[12] 101[8])
...
module sdram_ctrl_min (timer, SD_CLK_c, SD_BA_c_0, SD_CAS_N_c, SD_DQM_c_0, 
    ...
    FD1S3AX fs_sync_162 (.D(fs_meta), .CK(SD_CLK_c), .Q(fs_sync)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(73[14:70])
    ...
    FD1S3IX dq_oe_172 (.D(SD_A_12__N_789[6]), .CK(SD_CLK_c), .CD(n6743), 
            .Q(dq_oe)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam dq_oe_172.GSR = "DISABLED";
    FD1S3AX SD_BA__i1 (.D(bank[0]), .CK(SD_CLK_c), .Q(SD_BA_c_0)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    ...
    FD1S3AX SD_CAS_N_166 (.D(SD_CAS_N_N_809), .CK(SD_CLK_c), .Q(SD_CAS_N_c)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_CAS_N_166.GSR = "DISABLED";
    FD1S3AX SD_DQM_i1 (.D(SD_DQM_1__N_499[0]), .CK(SD_CLK_c), .Q(SD_DQM_c_0)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_DQM_i1.GSR = "DISABLED";
    FD1S3AX timer_i0 (.D(timer_15__N_529[0]), .CK(SD_CLK_c), .Q(timer[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i0.GSR = "DISABLED";
    FD1P3AX bank_i0 (.D(bank_1__N_523[0]), .SP(SD_CLK_c_enable_1), .CK(SD_CLK_c), 
            .Q(bank[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam bank_i0.GSR = "DISABLED";
    FD1P3IX ref_cnt_i0 (.D(n81), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i0.GSR = "DISABLED";
    FD1S3AX fs_meta_161 (.D(frame_start), .CK(SD_CLK_c), .Q(fs_meta)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(73[14:70])
    ...
    FD1S3IX SD_A_i10 (.D(n2895), .CK(SD_CLK_c), .CD(n3162), .Q(SD_A_c_9)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    ...
    FD1S3IX SD_A_i12 (.D(n2895), .CK(SD_CLK_c), .CD(n3163), .Q(SD_A_c_11)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    ...
    FD1P3JX ref_cnt_i6 (.D(\ref_cnt_15__N_561[6] ), .SP(SD_CLK_c_enable_30), 
            .PD(ref_cnt_15__N_577), .CK(SD_CLK_c), .Q(ref_cnt[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    ...
    FD1P3JX ref_cnt_i5 (.D(\ref_cnt_15__N_561[5] ), .SP(SD_CLK_c_enable_30), 
            .PD(ref_cnt_15__N_577), .CK(SD_CLK_c), .Q(ref_cnt[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    ...
    FD1S3JX SD_RAS_N_167 (.D(n767), .CK(SD_CLK_c), .PD(n87), .Q(SD_RAS_N_c)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    ...
    FD1S3AX SD_BA__i2 (.D(bank[1]), .CK(SD_CLK_c), .Q(SD_BA_c_1)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_BA__i2.GSR = "DISABLED";
    FD1S3IX SD_A_i1 (.D(n4753), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_0)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    ...
    FD1S3IX SD_A_i2 (.D(n4751), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_1)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i2.GSR = "DISABLED";
    FD1S3IX SD_A_i3 (.D(n1330[2]), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_2)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i3.GSR = "DISABLED";
    FD1S3IX SD_A_i4 (.D(n1330[3]), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_3)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i4.GSR = "DISABLED";
    FD1S3IX SD_A_i5 (.D(n4749), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_4)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i5.GSR = "DISABLED";
    FD1S3IX SD_A_i6 (.D(n1330[5]), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_5)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i6.GSR = "DISABLED";
    FD1S3IX SD_A_i7 (.D(n4755), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_6)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i7.GSR = "DISABLED";
    FD1S3IX SD_A_i8 (.D(n1330[7]), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_7)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i8.GSR = "DISABLED";
    FD1S3IX SD_A_i9 (.D(n1330[8]), .CK(SD_CLK_c), .CD(n3139), .Q(SD_A_c_8)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i9.GSR = "DISABLED";
    FD1S3AX SD_A_i11 (.D(SD_A_12__N_482[10]), .CK(SD_CLK_c), .Q(SD_A_c_10)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam SD_A_i11.GSR = "DISABLED";
    FD1S3JX timer_i1 (.D(n4741), .CK(SD_CLK_c), .PD(n626[8]), .Q(timer[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i1.GSR = "DISABLED";
    FD1S3AX timer_i2 (.D(timer_15__N_529[2]), .CK(SD_CLK_c), .Q(timer[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i2.GSR = "DISABLED";
    FD1S3AX timer_i3 (.D(timer_15__N_529[3]), .CK(SD_CLK_c), .Q(timer[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i3.GSR = "DISABLED";
    FD1S3AX timer_i4 (.D(timer_15__N_529[4]), .CK(SD_CLK_c), .Q(timer[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i4.GSR = "DISABLED";
    FD1S3AX timer_i5 (.D(timer_15__N_529[5]), .CK(SD_CLK_c), .Q(timer[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i5.GSR = "DISABLED";
    FD1S3AX timer_i6 (.D(timer_15__N_529[6]), .CK(SD_CLK_c), .Q(timer[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i6.GSR = "DISABLED";
    FD1S3AX timer_i7 (.D(timer_15__N_529[7]), .CK(SD_CLK_c), .Q(timer[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i7.GSR = "DISABLED";
    FD1S3AX timer_i8 (.D(timer_15__N_529[8]), .CK(SD_CLK_c), .Q(timer[8])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i8.GSR = "DISABLED";
    FD1S3AX timer_i9 (.D(timer_15__N_529[9]), .CK(SD_CLK_c), .Q(timer[9])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i9.GSR = "DISABLED";
    FD1S3AX timer_i10 (.D(timer_15__N_529[10]), .CK(SD_CLK_c), .Q(timer[10])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i10.GSR = "DISABLED";
    FD1S3AX timer_i11 (.D(timer_15__N_529[11]), .CK(SD_CLK_c), .Q(timer[11])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i11.GSR = "DISABLED";
    FD1S3AX timer_i12 (.D(timer_15__N_529[12]), .CK(SD_CLK_c), .Q(timer[12])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i12.GSR = "DISABLED";
    FD1S3AX timer_i13 (.D(timer_15__N_529[13]), .CK(SD_CLK_c), .Q(timer[13])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i13.GSR = "DISABLED";
    FD1S3AX timer_i14 (.D(timer_15__N_529[14]), .CK(SD_CLK_c), .Q(timer[14])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i14.GSR = "DISABLED";
    FD1S3AX timer_i15 (.D(timer_15__N_529[15]), .CK(SD_CLK_c), .Q(timer[15])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    defparam timer_i15.GSR = "DISABLED";
    FD1P3AX bank_i1 (.D(bank_1__N_523[1]), .SP(SD_CLK_c_enable_28), .CK(SD_CLK_c), 
            .Q(bank[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    ...
    FD1P3IX ref_cnt_i2 (.D(n75), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i2.GSR = "DISABLED";
    FD1P3IX ref_cnt_i3 (.D(n72_adj_1), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i3.GSR = "DISABLED";
    FD1P3IX ref_cnt_i4 (.D(n69_adj_2), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i4.GSR = "DISABLED";
    FD1P3IX ref_cnt_i7 (.D(n60_adj_3), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i7.GSR = "DISABLED";
    FD1P3IX ref_cnt_i8 (.D(n57_adj_4), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[8])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i8.GSR = "DISABLED";
    FD1P3IX ref_cnt_i9 (.D(n54), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[9])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i9.GSR = "DISABLED";
    FD1P3IX ref_cnt_i10 (.D(n51_adj_5), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[10])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i10.GSR = "DISABLED";
    FD1P3IX ref_cnt_i11 (.D(n48_adj_6), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[11])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i11.GSR = "DISABLED";
    FD1P3IX ref_cnt_i12 (.D(n45_adj_7), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[12])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i12.GSR = "DISABLED";
    FD1P3IX ref_cnt_i13 (.D(n42), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[13])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i13.GSR = "DISABLED";
    FD1P3IX ref_cnt_i14 (.D(n39_adj_8), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[14])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    defparam ref_cnt_i14.GSR = "DISABLED";
    FD1P3IX ref_cnt_i15 (.D(n36_adj_9), .SP(ref_due_N_811), .CD(ref_cnt_15__N_577), 
            .CK(SD_CLK_c), .Q(ref_cnt[15])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    ...
    FD1P3JX ref_cnt_i1 (.D(\ref_cnt_15__N_561[1] ), .SP(SD_CLK_c_enable_30), 
            .PD(ref_cnt_15__N_577), .CK(SD_CLK_c), .Q(ref_cnt[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(104[14] 105[59])
    ...
    FD1S3IX SD_A_i13 (.D(n2895), .CK(SD_CLK_c), .CD(n3164), .Q(SD_A_c_12)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
    ...
    FD1S3JX SD_WE_N_165 (.D(n3138), .CK(SD_CLK_c), .PD(SD_DQM_1__N_802[1]), 
            .Q(SD_WE_N_c)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=7, LSE_RCOL=6, LSE_LLINE=121, LSE_RLINE=141 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/sdram_ctrl_min.v(130[18] 224[12])
...
module spi_bridge (CCLK_c, DIN_c, stream_arm_spi, n6380, DOUT_c, stream_fifo_empty, 
    ...
    wire [1:0]mode_req;   // c:/users/kunsh/desktop/aicamera/lattice diamond/fpga_top.v(85[16:24])
    ...
    FD1P3AX cmd_i0_i0 (.D(DIN_c), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam cmd_i0_i0.GSR = "ENABLED";
    FD1P3AX stream_arm_80 (.D(n6380), .SP(CCLK_c_enable_5), .CK(CCLK_c), 
            .Q(stream_arm_spi)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    ...
    FD1P3AX mode_req_i0_i0 (.D(rx_byte[0]), .SP(CCLK_c_enable_26), .CK(CCLK_c), 
            .Q(mode_req[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam mode_req_i0_i0.GSR = "ENABLED";
    FD1P3AX rx_byte__i1 (.D(DIN_c), .SP(CCLK_c_enable_27), .CK(CCLK_c), 
            .Q(rx_byte[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam rx_byte__i1.GSR = "ENABLED";
    FD1S3AX shift_in_i1 (.D(DIN_c), .CK(CCLK_c), .Q(shift_in[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_in_i1.GSR = "ENABLED";
    FD1S3IX shift_out_i0 (.D(shift_out_7__N_1277[0]), .CK(CCLK_c), .CD(n5), 
            .Q(shift_out[0])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_out_i0.GSR = "ENABLED";
    FD1S3AX DOUT_78 (.D(shift_out[7]), .CK(CCLK_c), .Q(DOUT_c)) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    ...
    FD1P3AX cmd_i0_i1 (.D(shift_in[0]), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    ...
    FD1P3AX cmd_i0_i2 (.D(shift_in[1]), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam cmd_i0_i2.GSR = "ENABLED";
    FD1P3AX cmd_i0_i3 (.D(shift_in[2]), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam cmd_i0_i3.GSR = "ENABLED";
    FD1P3AX cmd_i0_i4 (.D(shift_in[3]), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam cmd_i0_i4.GSR = "ENABLED";
    FD1P3AX cmd_i0_i5 (.D(shift_in[4]), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam cmd_i0_i5.GSR = "ENABLED";
    FD1P3AX cmd_i0_i6 (.D(shift_in[5]), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam cmd_i0_i6.GSR = "ENABLED";
    FD1P3AX cmd_i0_i7 (.D(shift_in[6]), .SP(CCLK_c_enable_20), .CK(CCLK_c), 
            .Q(cmd[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    ...
    FD1P3AX mode_req_i0_i1 (.D(rx_byte[1]), .SP(CCLK_c_enable_26), .CK(CCLK_c), 
            .Q(mode_req[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam mode_req_i0_i1.GSR = "ENABLED";
    FD1P3AX rx_byte__i2 (.D(shift_in[0]), .SP(CCLK_c_enable_27), .CK(CCLK_c), 
            .Q(rx_byte[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam rx_byte__i2.GSR = "ENABLED";
    FD1S3AX shift_in_i2 (.D(shift_in[0]), .CK(CCLK_c), .Q(shift_in[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_in_i2.GSR = "ENABLED";
    FD1S3AX shift_in_i3 (.D(shift_in[1]), .CK(CCLK_c), .Q(shift_in[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_in_i3.GSR = "ENABLED";
    FD1S3AX shift_in_i4 (.D(shift_in[2]), .CK(CCLK_c), .Q(shift_in[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_in_i4.GSR = "ENABLED";
    FD1S3AX shift_in_i5 (.D(shift_in[3]), .CK(CCLK_c), .Q(shift_in[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_in_i5.GSR = "ENABLED";
    FD1S3AX shift_in_i6 (.D(shift_in[4]), .CK(CCLK_c), .Q(shift_in[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_in_i6.GSR = "ENABLED";
    FD1S3AX shift_in_i7 (.D(shift_in[5]), .CK(CCLK_c), .Q(shift_in[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_in_i7.GSR = "ENABLED";
    FD1S3AX shift_out_i1 (.D(shift_out_7__N_1209[1]), .CK(CCLK_c), .Q(shift_out[1])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_out_i1.GSR = "ENABLED";
    FD1S3AX shift_out_i2 (.D(shift_out_7__N_1209[2]), .CK(CCLK_c), .Q(shift_out[2])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_out_i2.GSR = "ENABLED";
    FD1S3AX shift_out_i3 (.D(shift_out_7__N_1209[3]), .CK(CCLK_c), .Q(shift_out[3])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_out_i3.GSR = "ENABLED";
    FD1S3AX shift_out_i4 (.D(shift_out_7__N_1209[4]), .CK(CCLK_c), .Q(shift_out[4])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_out_i4.GSR = "ENABLED";
    FD1S3AX shift_out_i5 (.D(shift_out_7__N_1209[5]), .CK(CCLK_c), .Q(shift_out[5])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_out_i5.GSR = "ENABLED";
    FD1S3AX shift_out_i6 (.D(shift_out_7__N_1209[6]), .CK(CCLK_c), .Q(shift_out[6])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
    defparam shift_out_i6.GSR = "ENABLED";
    FD1S3AX shift_out_i7 (.D(shift_out_7__N_1209[7]), .CK(CCLK_c), .Q(shift_out[7])) /* synthesis LSE_LINE_FILE_ID=4, LSE_LCOL=16, LSE_RCOL=6, LSE_LLINE=216, LSE_RLINE=235 */ ;   // c:/users/kunsh/desktop/aicamera/lattice diamond/spi_bridge.v(90[18] 130[12])
