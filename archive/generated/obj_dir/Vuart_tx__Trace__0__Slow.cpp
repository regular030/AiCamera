...
VL_ATTR_COLD void Vuart_tx___024root__trace_init_sub__TOP__0(Vuart_tx___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+17,0,"CLKS_PER_BIT_M1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
...
VL_ATTR_COLD void Vuart_tx___024root__trace_full_0_sub_0(Vuart_tx___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelf->uart_tx__DOT__st),2);
    bufp->fullSData(oldp+2,(vlSelf->uart_tx__DOT__clk_cnt),16);
    bufp->fullCData(oldp+3,(vlSelf->uart_tx__DOT__bit_idx),3);
    bufp->fullCData(oldp+4,(vlSelf->uart_tx__DOT__shreg),8);
    ...
    bufp->fullBit(oldp+9,(vlSelf->tx));
    bufp->fullBit(oldp+10,(vlSelf->busy));
    bufp->fullBit(oldp+11,(vlSelf->done));
}
