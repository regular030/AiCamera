...
void Vuart_rx___024root__trace_chg_0_sub_0(Vuart_rx___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgCData(oldp+0,(vlSelf->uart_rx__DOT__st),2);
        bufp->chgSData(oldp+1,(vlSelf->uart_rx__DOT__clk_cnt),16);
        bufp->chgCData(oldp+2,(vlSelf->uart_rx__DOT__bit_idx),3);
        bufp->chgCData(oldp+3,(vlSelf->uart_rx__DOT__shreg),8);
        bufp->chgBit(oldp+4,(vlSelf->uart_rx__DOT__rx_s1));
        bufp->chgBit(oldp+5,(vlSelf->uart_rx__DOT__rx_s2));
    }
    ...
    bufp->chgBit(oldp+10,(vlSelf->valid));
}
